...
const Index = () => {
  ...
  const MainContent = () => (
    <div className="min-h-screen relative overflow-hidden">
      {/* Blue top section */}
      <div className="relative" style={{ background: 'linear-gradient(135deg, rgb(60, 71, 157) 0%, rgb(45, 55, 135) 50%, rgb(30, 40, 115) 100%)' }}>
        ...
        <div className="relative z-10 text-white">
          <div className="container mx-auto px-4 py-12">
            ...
            <div className="max-w-4xl mx-auto flex justify-start relative z-30 pb-16">
              <Button 
